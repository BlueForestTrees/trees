...
import {withItem, withTrunk, withTrunkNoQt} from "../util/testUtil";
...
export const gateauItem = withItem(gateauTrunk._id, 500, "g");
...
const gateauImpact = {...withItem(gateauTrunk._id, 500, "g"), items: [withItem(vitCImpactEntry._id, 10, "mol"), withItem(vitBImpactEntry._id, 100, "mmol")]};
